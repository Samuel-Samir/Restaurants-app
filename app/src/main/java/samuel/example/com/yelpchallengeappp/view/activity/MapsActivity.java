        ...
        RequestObserver
{
    ...
    // The entry point to Google Play services, used by the MedicalPlaces API and Fused Location Provider.
...
/*
     ...
     * Uses the addApi() method to request the Google MedicalPlaces API and the Fused Location Provider.
     */
